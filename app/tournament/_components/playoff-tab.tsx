      ...
      return (
        <div className="flex items-center gap-2 min-w-0 flex-1">
          ...
          <div className="flex flex-col min-w-0 flex-1">
            <span className="leading-tight text-xs xl:text-sm font-bold text-foreground flex items-center gap-1">
              <span className="truncate">{isWinner ? teamData.teamName.replace(" ✓", "") : teamData.teamName}</span>
...
export function PlayoffTab({
  ...
  return (
    <div className="w-full flex flex-col gap-6 rounded-3xl border border-border bg-card p-4 sm:p-6 xl:p-8 shadow-xl">
      ...
      {/* HP = 1 Kolom (ke bawah) | PC / Laptop (lg ke atas) = 4 Kolom Melebar */}
