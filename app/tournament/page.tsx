...
export default function TournamentLandingPage() {
  ...
  return (
    <div className="min-h-screen w-full bg-background text-foreground flex flex-col">
      ...
      {/* 🎛️ MAIN MODULE SWITCHER (TOURNAMENT VS ANALYST) */}
      <nav className="sticky top-0 z-40 w-full border-b border-border bg-background/80 backdrop-blur-md py-3 px-4">
        <div className="max-w-4xl mx-auto flex items-center justify-center gap-3">
          <button
            ...
            className={`flex items-center gap-2 rounded-2xl px-6 py-2.5 text-xs font-black uppercase tracking-wider transition-all ${
