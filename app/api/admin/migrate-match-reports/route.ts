...
export async function POST(req: Request) {
  try {
    ...
    for (const match of schedule) {
      ...
      // 1. Metadata murni (hanya date, streamPlatform, streamer, referee, streamUrl)
      const metadata = {
      ...
      // 3. Susun dokumen baru murni sesuai kesepakatan
      const cleanReport = {
        matchId: match.id,
      ...
      // Timpa data lama dengan data baru yang sudah bersih
