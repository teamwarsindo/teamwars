    ...
    <div className="rounded-2xl border border-border bg-card text-card-foreground shadow-lg overflow-hidden flex flex-col">
      ...
      <div className="border-b border-border bg-muted/40 p-4 space-y-3.5">
        ...
        <div className="flex items-center justify-center gap-3 sm:gap-4 flex-wrap">
          ...
          <span className="text-xs font-black text-muted-foreground uppercase px-1">
            VS
          </span>
              ...
              <Fragment key={msg.id}>
                {isNewDay && (
                  <div className="relative flex items-center justify-center my-3">
                    ...
                    <span className="relative bg-card border border-border px-3 py-0.5 rounded-full text-[10px] font-bold text-muted-foreground shadow-2xs">
                      {currentDateHeader}
                    </span>
                  </div>
                )}
