...
export function PowerRankingTable({
  ...
  // Indikator delta hanya untuk rank 1 - 99
                    ...
                    <td className="py-2.5 pl-3.5 sm:pl-4 pr-1 text-center">
                      <div className="flex items-center justify-center font-mono">
                        {p.isNew ? (
                          ...
                          // Peringkat 100 ke atas: hanya tampilkan angka tanpa penanda
                          <span className="text-foreground/90 font-bold text-xs">
                            {p.rank}
                          </span>
                        ) : (
                          // Peringkat 1 - 99: tampilkan delta dan angka rapat
