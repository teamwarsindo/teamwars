...
export function PowerRankingPodium({
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl border-2 border-amber-500/50 bg-gradient-to-r from-amber-500/15 via-card to-card p-2.5 sm:p-3 shadow-xs transition hover:shadow-md flex items-center justify-between gap-2">
      {/* ── Sisi Kiri: Badge #1, Avatar Tim Bulat, Info Player & Tim ── */}
      <div className="flex items-center gap-2.5 min-w-0">
        <div className="relative shrink-0">
          <div className="h-10 w-10 sm:h-11 sm:w-11 rounded-full border-2 border-amber-500 overflow-hidden bg-background flex items-center justify-center shadow-inner">
            {logo ? (
              <Image
                src={logo}
                alt={top1.teamName}
          ...
          {/* Crown badge mini di sudut avatar */}
